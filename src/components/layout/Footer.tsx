...
const NewsletterForm: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Honeypot field */}
      <div
        className="absolute opacity-0 -z-50 h-0 w-0 overflow-hidden"
        aria-hidden="true"
      >
        <label htmlFor="bot-field-newsletter">
      ...
      <p className="text-xs text-neutral-400 leading-relaxed">
        Subscribe to receive selected insights, company updates, and
        perspectives on emerging technology and digital transformation.
      </p>
        ...
        <div className="flex gap-2">
          <input
            ...
            className={[
              ...
              errors.email
                ...
                : 'border-neutral-700 focus:border-hive-yellow',
            ].join(' ')}
          />
          ...
          <button
            ...
            className={[
              ...
              'focus-visible:ring-offset-2 focus-visible:ring-offset-hive-black',
  ...
  return (
    <footer className="bg-hive-black text-white">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, #FDCF09 0%, #F69822 50%, #FDCF09 100%)',
        }}
        aria-hidden="true"
      />
      ...
      <Container size="lg">
        ...
        <div className="pt-14 pb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 border-b border-neutral-800">
          ...
          <div className="sm:col-span-2 space-y-5 max-w-xs">
            ...
            <p className="text-sm text-neutral-400 leading-relaxed">
              M3 Hive helps organisations transform ambitious ideas into secure,
            ...
            <div
              ...
              aria-label="M3 Hive social media links"
            >
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/m3-hive/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit M3 Hive on LinkedIn"
                title="LinkedIn"
                className="
                  group
                  w-8 h-8
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/m3hive/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit M3 Hive on Instagram"
                title="Instagram"
                className="
                  group
                  w-8 h-8
        ...
        <div className="py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-[11px] text-neutral-500">
          <p>© M3 Hive 2026. All rights reserved.</p>
